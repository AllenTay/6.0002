...
class Digraph(object):
    ...
    def get_edges_for_node(self, node): # This returns nodes that are connected to it 
    ...
    def add_edge(self, edge):
        ...
        if not (Node(src) in self.edges and Node(dest) in  self.edges):
            raise ValueError('Node not in graph')
        self.edges[src].append(edge) #why do you append an edge
